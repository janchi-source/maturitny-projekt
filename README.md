...
├── config.py                    \# Konfigurácia appky (SECRET\_KEY, DB URI, cesta na upload)

├── run.py                       \# Vstupný bod – \`python run.py\`

├── app/

│   ├── \_\_init\_\_.py              \# Flask app factory, registrácia blueprintov
...
│   │   └── document\_service.py  \# Logika extrakcie textu z PDF/DOCX
...
│   │   │   ├── stats\_card.html  \# Znovupoužiteľná komponenta pre stat kartu

│   │   │   ├── project\_row.html \# Komponenta pre riadok priebehu projektu

│   │   │   ├── task\_row.html    \# Komponenta pre riadok tabuľky úloh

│   │   │   ├── document\_card.html \# Komponenta pre položku zoznamu dokumentov
