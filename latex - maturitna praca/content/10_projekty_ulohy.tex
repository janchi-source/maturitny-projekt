...
informáciami -- názvom, progresom a~poslednou aktualizáciou (obr.~ef{fig:projekty}).
...
a~históriu aktivity (obr.~ef{fig:detail_projektu}). Projekt je možné upraviť alebo odstrániť len vlastníkovi
...
drag-and-drop interakciou priamo v~prehliadači (obr.~ef{fig:kanban}).
...
a~dokumentom v~súlade so svojou systémovou rolou (obr.~ef{fig:clenovia}).
